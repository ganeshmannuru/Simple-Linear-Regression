...
plt.show()
# by this i have seen the probability distribusion function and QQ plot of YearsExperience
#==========================================================================
import scipy.stats as stats
import matplotlib.pyplot as plt
import seaborn as sns
...
plt.show()
# by this i have seen the probability distribusion function and QQ plot of Salary
#===============================================================
# scatter plot
import matplotlib.pyplot as plt
...
# matrix
from sklearn.metrics import mean_squared_error
mse = mean_squared_error(Y, Y_pred_Transform1)
print('Mean squared error',mse.round(3))
#==========================================================
...
# matrix
from sklearn.metrics import mean_squared_error
mse = mean_squared_error(Y, Y_pred_Transform2)
print('Mean squared error',mse.round(3))
#============================================================
